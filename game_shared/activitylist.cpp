...
//===========================
	...
	// IRONSIGHT
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_FROM );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_PRIMARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_TO );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_COCK );

	REGISTER_SHARED_ACTIVITY( ACT_VM_COCK );
...
*/
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_VAULT );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_VAULT2 );
...
// ------------
	...
	REGISTER_SHARED_ACTIVITY ( ACT_PRONE_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_PRONE_MOVE );
	
	// View Model
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DEPLOY );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_IDLE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_UNDEPLOY );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_BIPOD_PRIMARYATTACK );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_PRIMARYATTACK_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DRYFIRE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RELOAD_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RELOADMID );

   	// Basic activities
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_AIM );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_AIM );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_AIM );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_DEPLOYED_AIM );
	
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_WALK );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_WALK_AIM );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_WALK_CROUCH );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_WALK_CROUCH_AIM );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_RUN );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_RUN_AIM );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_SPRINT );
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_MOVE_PRONE );

	REGISTER_SHARED_ACTIVITY (ACT_HAJ_DEPLOY);
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_PRONE_DEPLOY);

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP );

	// Attack and Reload
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STANDTOPRONE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHTOPRONE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONETOCROUCH );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONETOSTAND );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SIT_GROUND_ENTRY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SIT_GROUND );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SIT_GROUND_EXIT );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PICKUP_GROUND );

	//-- Weapon activities--

	// Generic/Bolt Action
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_AIM_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_AIM_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_AIM_BOLT );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_AIM_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_BOLT );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_BOLT );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_BOLT );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH_BOLT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE_BOLT );

	// MP40
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_AIM_MP40 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_MP40 );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_MP40 );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_MP40 );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE_MP40 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_BREN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_MG34 );

/*
	// STEN Mk3
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_AIM_STEN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_STEN );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_STEN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_STEN );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE_STEN );

	// STEN Mk5
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_AIM_STEN5 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_STEN5 );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_STEN5 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_STEN5 );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE_STEN5 );

	// BREN
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_DEPLOYED_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MG_DEPLOYED );
		
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_BREN );

	REGISTER_SHARED_ACTIVITY (ACT_HAJ_DEPLOY_BREN);
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_PRONE_DEPLOY_BREN);
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_BREN );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_BREN );

	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE_BREN );
*/
/*
	// MG34
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_MG34 );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_MG34 );

	REGISTER_SHARED_ACTIVITY (ACT_HAJ_DEPLOY_MG34);
	REGISTER_SHARED_ACTIVITY (ACT_HAJ_PRONE_DEPLOY_MG34);
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_MG34 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_MG34 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_CROUCH_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_RELOAD_PRONE_MG34 );
*/

	// Frag Grenade
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_GREN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_GREN );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_GREN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_GREN );

	// Stick Grenade
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_STICK );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_STICK );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_STICK );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_STICK );

	// Knife
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_KNIFE );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_KNIFE );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_KNIFE );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_KNIFE );

	// Shovel
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_CROUCH_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_IDLE_PRONE_SHOVEL );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_CROUCH_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_MOVE_PRONE_SHOVEL );
	
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_SHOVEL );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_GESTURE_ATTACK_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_SHOVEL );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_SHOVEL );

	///// NEW  /////
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_KAR );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_KAR );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_ENFIELD );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_ENFIELD );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_MP40 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_MP40 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_TOMMY );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_STEN5 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_STEN5 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_STEN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_STEN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_DEPLOY_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_DEPLOY_BREN );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_BREN );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_DEPLOY_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_DEPLOY_MG34 );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_JUMP_MG34 );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_CROUCH_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_GREN_FRAG );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_GREN_FRAG );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_CROUCH_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_GREN_STICK );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_GREN_STICK );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_CROUCH_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_IDLE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_IDLE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_TNT );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_TNT );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_SPADE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_SPADE );

	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCH_IDLE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_CROUCHWALK_IDLE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRIMARYATTACK_PRONE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONE_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_PRONEWALK_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_CROUCH_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RELOAD_PRONE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_RUN_IDLE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_SPRINT_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_STAND_IDLE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_AIM_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_HAJ_WALK_IDLE_KNIFE );
