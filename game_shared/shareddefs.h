...
#define VEC_DUCK_MOVE_VIEW	g_pGameRules->GetViewVectors()->m_vDuckViewMove
...
#define TIME_TO_DUCK		( player->m_Local.IsVaulting() ? 0.1 : 0.4 )
...
enum
{
	...
	/* HAJ 020 - Jed */
	// Ham and Jam constants
	MUZZLEFLASH_HAJ_PISTOL,
	MUZZLEFLASH_HAJ_RIFLE,
	MUZZLEFLASH_HAJ_SMG,
	MUZZLEFLASH_HAJ_LMG,
	MUZZLEFLASH_HAJ_HMG,
...
enum PLAYER_ANIM
{
	...
	// HaJ stuff
	PLAYER_DEPLOYBIPOD,
	PLAYER_UNDEPLOYBIPOD,
	PLAYER_PRONETRANSITION
};
