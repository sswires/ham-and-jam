...
// *HAJ 020* - Jed
// Class definitions - collect the set!
enum
{
	CLASS_UNASSIGNED = 0,	
	CLASS_RIFLEMAN,			// Enfield/Kar98
	CLASS_ASSAULT,			// Sten/MP40
	CLASS_SUPPORT,			// Bren/MG34
	CLASS_LAST,				// Used to test against upper limit
};

// enumeration of ranks for commonwealth team
enum {
	CWEALTH_RANK_PVT = 0,
	CWEALTH_RANK_LCPL,
	CWEALTH_RANK_CPL,
...
// enumeration of name to index mapping for models
enum {
	CWEALTH_DEFAULT_RIFLEMAN = 0,
	CWEALTH_DEFAULT_ASSAULT,
	CWEALTH_DEFAULT_SUPPORT,
};

// body groups within the player models
#define PLAYER_BODYGROUP_INSIGNIA 2
#define PLAYER_BODYGROUP_RANK 3
