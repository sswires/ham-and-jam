...
void CBaseHL2MPBludgeonWeapon::ImpactEffect( trace_t &traceHit )
{
	...
	UTIL_ImpactTrace( &traceHit, DMG_CLUB, "ImpactMelee" );
...
void CBaseHL2MPBludgeonWeapon::Swing( int bIsSecondary )
{
	...
	CHajPlayer *pHajPlayer = ToHajPlayer(pOwner);

	if( pHajPlayer )
		pHajPlayer->DoAnimationEvent( PLAYERANIMEVENT_ATTACK_PRIMARY );
