...
struct Ammo_t 
{
	...
	// HaJ: added for magazine system
	int					iMagazineCapacity;
...
public:
	...
	// HaJ: Added function for magazine system
	void				AddAmmoType(char const* name, int damageType, int tracerType, int plr_dmg, int npc_dmg, int carry, int magSize, float physicsForceImpulse, int nFlags, int minSplashSize = 4, int maxSplashSize = 8 );
