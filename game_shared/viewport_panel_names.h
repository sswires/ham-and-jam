...
#define PANEL_HAJCLASS		"hajclass"
#define PANEL_TEAM			"team"
#define PANEL_HAJCLASS_CWEALTH		"hajclass_cwealth"
#define PANEL_HAJCLASS_AXIS			"hajclass_axis"
...
#define PANEL_VOICE			"voice"


#endif // VIEWPORT_PANEL_NAMES_