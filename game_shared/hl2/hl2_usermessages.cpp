...
{
// *HAJ 020* - Jed
// HAJ doesn't use these messages
#ifndef HAJ_DLL	
	...
	usermessages->Register( "Concuss", 5 ); // Concussion network message
	usermessages->Register( "HajPlayerHint", -1 );
	usermessages->Register( "HajPlayerNotification", -1 );
