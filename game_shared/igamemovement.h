...
public:
	...
	virtual Vector const&	GetPlayerMins( bool ducked, bool proned ) const = 0;
	virtual Vector const&	GetPlayerMaxs( bool ducked, bool proned) const = 0;
	virtual Vector const&   GetPlayerViewOffset( bool ducked, bool proned ) const = 0;
};
