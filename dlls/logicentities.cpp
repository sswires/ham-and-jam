...
{
	if ( _serverGameDLL.m_fAutoSaveDangerousTime != 0.0f && _serverGameDLL.m_fAutoSaveDangerousTime >= gpGlobals->curtime )
	{
	...
	_serverGameDLL.m_fAutoSaveDangerousTime = gpGlobals->curtime + inputdata.value.Float();
}
