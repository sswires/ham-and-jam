...
void FinishClientPutInServer( CHL2MP_Player *pPlayer )
{
	...
	data->SetString( "cmd", "chooseteam" );	// *HaJ 202* SteveUK - added it so the choose team menu appears when you click "ok"
...
void ClientGamePrecache( void )
{
	...
	CBaseEntity::PrecacheModel( "models/player/helmets/helmet_mkii.mdl" );
}
...
{
	// vanilla deathmatch
	CreateGameRulesObject( "CHajGameRules" );
}
