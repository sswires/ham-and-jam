...
*/
	...
	// IRONSIGHT
	ADD_ACTIVITY_TO_SR ( ACT_VM_IRONSIGHT_FROM );
	ADD_ACTIVITY_TO_SR ( ACT_VM_IRONSIGHT_IDLE );
	ADD_ACTIVITY_TO_SR ( ACT_VM_IRONSIGHT_PRIMARYATTACK );
	ADD_ACTIVITY_TO_SR ( ACT_VM_IRONSIGHT_TO );
...
*/
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_VAULT );
	ADD_ACTIVITY_TO_SR( ACT_MP_VAULT2 );
	...
	// Ham and Jam
	ADD_ACTIVITY_TO_SR ( ACT_PRONE_IDLE );
	ADD_ACTIVITY_TO_SR ( ACT_PRONE_MOVE );
	
	// View Model
	ADD_ACTIVITY_TO_SR ( ACT_VM_DEPLOY );
	ADD_ACTIVITY_TO_SR ( ACT_VM_IDLE_DEPLOYED );
	ADD_ACTIVITY_TO_SR ( ACT_VM_UNDEPLOY );
	ADD_ACTIVITY_TO_SR ( ACT_VM_BIPOD_PRIMARYATTACK );
	ADD_ACTIVITY_TO_SR ( ACT_VM_PRIMARYATTACK_DEPLOYED );
	ADD_ACTIVITY_TO_SR ( ACT_VM_DRYFIRE_DEPLOYED );
	ADD_ACTIVITY_TO_SR ( ACT_VM_RELOAD_DEPLOYED );

	// Basic activities
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_AIM );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_AIM );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_AIM );
	
	ADD_ACTIVITY_TO_SR (ACT_HAJ_WALK );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_WALK_AIM );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_WALK_CROUCH );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_WALK_CROUCH_AIM );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_RUN );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_RUN_AIM );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_SPRINT );
	ADD_ACTIVITY_TO_SR (ACT_HAJ_MOVE_PRONE );

	ADD_ACTIVITY_TO_SR (ACT_HAJ_DEPLOY);
	ADD_ACTIVITY_TO_SR (ACT_HAJ_PRONE_DEPLOY);

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP );

	// Attack and Reload
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_CROUCH );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_PRONE );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STANDTOPRONE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCHTOPRONE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONETOCROUCH );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONETOSTAND );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SIT_GROUND_ENTRY );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SIT_GROUND );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SIT_GROUND_EXIT );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PICKUP_GROUND );

	//-- Weapon activities--

	// Generic/Bolt Action
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_AIM_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_AIM_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_AIM_BOLT );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_AIM_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_BOLT );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_BOLT );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_BOLT );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_CROUCH_BOLT );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_PRONE_BOLT );

	// MP40
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_AIM_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_AIM_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_AIM_MP40 );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_AIM_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_MP40 );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_MP40 );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_MP40 );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_CROUCH_MP40 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_PRONE_MP40 );

	// STEN Mk2
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_AIM_STEN );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_STEN );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_STEN );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_STEN );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_CROUCH_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_PRONE_STEN );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCH_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCH_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCHWALK_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCHWALK_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONE_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONEWALK_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_CROUCH_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_PRONE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STAND_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STAND_IDLE_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_STEN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_IDLE_STEN );

	// STEN Mk5
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_AIM_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_AIM_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_AIM_STEN5 );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_AIM_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_STEN5 );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_STEN5 );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_STEN5 );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_CROUCH_STEN5 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_RELOAD_PRONE_STEN5 );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_PRONE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STAND_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STAND_AIM_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCH_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCH_AIM_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCHWALK_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONEWALK_IDLE_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONE_AIM_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_DEPLOY_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONE_DEPLOY_BREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_BREN );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RELOAD_PRONE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STAND_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_STAND_AIM_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_AIM_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCH_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCH_AIM_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_CROUCHWALK_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_AIM_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONEWALK_IDLE_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONE_AIM_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_DEPLOY_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRONE_DEPLOY_MG34 );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_MG34 );

	// Frag Grenade
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_GREN );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_GREN );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_GREN );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_GREN );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_GREN );

	// Stick Grenade
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_STICK );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_STICK );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_STICK );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_STICK );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_STICK );

	// Knife
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_KNIFE );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_KNIFE );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_KNIFE );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_KNIFE );

	// Shovel
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_CROUCH_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_IDLE_PRONE_SHOVEL );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_WALK_CROUCH_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_RUN_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_SPRINT_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_MOVE_PRONE_SHOVEL );
	
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_JUMP_SHOVEL );

	ADD_ACTIVITY_TO_SR ( ACT_HAJ_GESTURE_ATTACK_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_PRONE_DEPLOYED_SHOVEL );
	ADD_ACTIVITY_TO_SR ( ACT_HAJ_PRIMARYATTACK_DEPLOYED_SHOVEL );
}
