...
void CHudCrosshair::ApplySchemeSettings( vgui::IScheme *scheme )
{
...
bool CHudCrosshair::ShouldDraw( void )
{
	...
	if( pWeapon && ( pWeapon->IsIronsighted() || pWeapon->m_bIsBipodDeployed || ( crosshair_dynamic.GetBool() && !pWeapon->ShouldForceTextureCrosshair() )) )
		return false;
