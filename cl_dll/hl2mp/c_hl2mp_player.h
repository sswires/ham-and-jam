...
public:
	...
	QAngle GetAnimEyeAngles( void ) { return EyeAngles(); }
	...
	void	AddViewOffset( const QAngle &angleOffset );	// HAJ 020 - Jed - Used by recoil

	HL2MPPlayerState State_Get() const;

	// *HAJ 020 - Jed
	int		GetCurrentClass() { return m_iCurrentClass; };
	int		GetCurrentRank() { return m_iRank; };
	int		GetDesiredClass() { return m_iDesiredClass; };
	int		GetDesiredTeam() { return m_iDesiredTeam; };
