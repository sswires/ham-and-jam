...
// Purpose: Handle weapon impacts
//-----------------------------------------------------------------------------
void ImpactMeleeCallback( const CEffectData &data )
{
	VPROF_BUDGET( "ImpactMeleeCallback", VPROF_BUDGETGROUP_PARTICLE_RENDERING );
...
DECLARE_CLIENT_EFFECT( "ImpactMelee", ImpactMeleeCallback );
