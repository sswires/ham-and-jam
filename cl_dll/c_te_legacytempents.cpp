...
void CTempEnts::MuzzleFlash( int type, ClientEntityHandle_t hEntity, int attachmentIndex, bool firstPerson )
{
	...
	/* HAJ 020 - Jed */
	// Add HAJ Muzzleflashes
	case MUZZLEFLASH_HAJ_PISTOL:
		if ( firstPerson )
		{
			MuzzleFlash_Pistol_Player( hEntity, attachmentIndex );
		}
	...
	case MUZZLEFLASH_HAJ_SMG:
		if ( firstPerson )
		{
			MuzzleFlash_SMG_Player( hEntity, attachmentIndex );
		}
		else
		{
			MuzzleFlash_SMG_NPC( hEntity, attachmentIndex );
		}
		break;

	case MUZZLEFLASH_HAJ_LMG:
		if ( firstPerson )
		{
			MuzzleFlash_LMG_Player( hEntity, attachmentIndex );
		}
		else
		{
			MuzzleFlash_LMG_NPC( hEntity, attachmentIndex );
		}
		break;

	case MUZZLEFLASH_HAJ_HMG:
		if ( firstPerson )
		{
			MuzzleFlash_HMG_Player( hEntity, attachmentIndex );
		}
		else
		{
			MuzzleFlash_HMG_NPC( hEntity, attachmentIndex );
		}
		break;
...
void CTempEnts::MuzzleFlash_Rifle_Player( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	...
	CSmartPtr<CSimpleEmitter> pSimple = CSimpleEmitter::Create( "MuzzleFlash_Rifle_Player" );
	pSimple->SetDrawBeforeViewModel( true );
	...
	if ( random->RandomInt( 0, 3 ) != 0 )
	{
		...
		pParticle->m_uchStartAlpha	= random->RandomInt( 24, 48 );
		pParticle->m_uchEndAlpha	= 0;
	...
	for ( int i = 1; i < 6; i++ )
	{
		...
		pParticle->m_uchStartSize	= ( (random->RandomFloat( 8.0f, 12.0f ) * (8-(i))/6) * flScale );
		pParticle->m_uchEndSize		= pParticle->m_uchStartSize;
		pParticle->m_flRoll			= random->RandomInt( 0, 360 );
		pParticle->m_flRollDelta	= 0.0f;
	}
...
//==================================================
// HAJ 020 - Jed
// Purpose: SMG Muzzleflashes
//==================================================
void CTempEnts::MuzzleFlash_SMG_NPC( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	FX_MuzzleEffectAttached( 1.0f, hEntity, attachmentIndex, NULL, true );
}

void CTempEnts::MuzzleFlash_SMG_Player( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	VPROF_BUDGET( "MuzzleFlash_SMG_Player", VPROF_BUDGETGROUP_PARTICLE_RENDERING );
	CSmartPtr<CSimpleEmitter> pSimple = CSimpleEmitter::Create( "MuzzleFlash_SMG_Player" );
	pSimple->SetDrawBeforeViewModel( true );
	...
	if ( random->RandomInt( 0, 3 ) != 0 )
	{
		...
		pParticle->m_uchStartSize	= random->RandomInt( 6, 7 );
		pParticle->m_uchEndSize		= pParticle->m_uchStartSize * 8.0f;
		pParticle->m_flRoll			= random->RandomInt( 0, 360 );
		pParticle->m_flRollDelta	= random->RandomFloat( -0.9f, 0.9f );
	}
...
//==================================================
// HAJ 020 - Jed
// Purpose: LMG Muzzleflashes
//==================================================
void CTempEnts::MuzzleFlash_LMG_NPC( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	FX_MuzzleEffectAttached( 1.0f, hEntity, attachmentIndex, NULL, true );
}

void CTempEnts::MuzzleFlash_LMG_Player( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	VPROF_BUDGET( "MuzzleFlash_LMG_Player", VPROF_BUDGETGROUP_PARTICLE_RENDERING );
	CSmartPtr<CSimpleEmitter> pSimple = CSimpleEmitter::Create( "MuzzleFlash_LMG_Player" );
	pSimple->SetDrawBeforeViewModel( true );
...
//==================================================
// HAJ 020 - Jed
// Purpose: HMG Muzzleflashes
//==================================================
void CTempEnts::MuzzleFlash_HMG_NPC( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	FX_MuzzleEffectAttached( 1.0f, hEntity, attachmentIndex, NULL, true );
}

void CTempEnts::MuzzleFlash_HMG_Player( ClientEntityHandle_t hEntity, int attachmentIndex )
{
	VPROF_BUDGET( "MuzzleFlash_HMG_Player", VPROF_BUDGETGROUP_PARTICLE_RENDERING );
	CSmartPtr<CSimpleEmitter> pSimple = CSimpleEmitter::Create( "MuzzleFlash_HMG_Player" );
	pSimple->SetDrawBeforeViewModel( true );
