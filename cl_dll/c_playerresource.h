...
//	virtual int		GetPacketloss( int index );
	...
	virtual int		GetPlayerClass( int iIndex );
	virtual int		GetObjectiveScore( int iIndex );
	virtual float	GetCombatEffectiveness( int iIndex );
...
protected:
	...
	int		m_iObjectiveScore[MAX_PLAYERS+1];
