...
// *HAJ 020* Jed - Add our game menu logo image
#include "haj\haj_vgui_menu_logo.h"
#include "haj/haj_vgui_version.h"
...
// Purpose: 
//-----------------------------------------------------------------------------
extern CVersionPanel *g_pVersionPanel;
void VGui_CreateGlobalPanels( void )
{
	...
	g_pVersionPanel = new CVersionPanel( GameUiDll );
...
void VGui_Shutdown()
{
	...
	// *HAJ 020* Jed - Remove our game menu logo image
	Top->Destroy();

	if( g_pVersionPanel )
	{
		g_pVersionPanel->SetParent( (vgui::Panel *)NULL );
		delete g_pVersionPanel;
	}
