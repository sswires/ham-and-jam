...
private:
	...
	// SMG					
	void					MuzzleFlash_SMG_Player( ClientEntityHandle_t hEntity, int attachmentIndex );
	void					MuzzleFlash_SMG_NPC( ClientEntityHandle_t hEntity, int attachmentIndex );

	// LMG					
	void					MuzzleFlash_LMG_Player( ClientEntityHandle_t hEntity, int attachmentIndex );
	void					MuzzleFlash_LMG_NPC( ClientEntityHandle_t hEntity, int attachmentIndex );

	// HMG					
	void					MuzzleFlash_HMG_Player( ClientEntityHandle_t hEntity, int attachmentIndex );
	void					MuzzleFlash_HMG_NPC( ClientEntityHandle_t hEntity, int attachmentIndex );
};
