...
#define	TRACER_MAX_HEAR_DIST	256	// *HAJ 020* - Jed. John says this makes you hear tracer whizz more
	...
	case TRACER_TYPE_DEFAULT:
		{
			...
			// *HAJ 020* - Jed.
			// Took this out because it was preventing whizz sounds
			// 256 is a good distance so we'll just use TRACER_MAX_HEAR_DIST instead
			//flWhizDist = 24;
